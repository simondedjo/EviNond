...
public class RoutingSample extends Activity implements
    ...
    // Feature point
    Point floodPoint;
    SimpleMarkerSymbol floodPointSymbol = new SimpleMarkerSymbol(Color.BLUE, 5, SimpleMarkerSymbol.STYLE.CIRCLE);
    Graphic graphic;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize an empty graphicLayer
        ...
        //Point wgsPt = (Point) GeometryEngine.project(floodPoint,map.getSpatialReference(),
    ...
    private class MyLocationListener implements LocationListener {
        ...
        public void onLocationChanged(Location loc) {
            ...
            map.setOnSingleTapListener(new OnSingleTapListener(){
                @Override
                public void onSingleTap(float x, float y) {
                    floodPoint = map.toMapPoint(x, y);
                    floodPointSymbol = new SimpleMarkerSymbol(Color.RED, 13,
                            SimpleMarkerSymbol.STYLE.SQUARE);
                    graphic = new Graphic(floodPoint, floodPointSymbol);

                    int numberOfGraphics = graphicsLayer.getNumberOfGraphics();
                    ...
                    Point wgsPt = (Point) GeometryEngine.project(floodPoint,map.getSpatialReference(),
                            SpatialReference.create(4326));
                    String lon1 = String.valueOf(wgsPt.getX());
                    String lat1 = String.valueOf(wgsPt.getY());
                    Toast.makeText(getApplicationContext(), lon1+" "+lat1,
